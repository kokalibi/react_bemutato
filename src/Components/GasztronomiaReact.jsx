export default function Gasztr() {
    return (
      <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-2xl">
        <h4 className="text-2xl font-bold text-gray-800 mb-4">Ronda gasztronómiája: Andalúz ízek a sziklák között</h4>
        <p className="text-gray-700 mb-4">
          Ronda, a festői andalúziai város nemcsak lélegzetelállító szurdokairól és történelmi hídjairól híres,
          hanem gazdag gasztronómiai hagyományairól is. A helyi konyha a hegyvidéki adottságokból és az andalúz
          ízvilágból merít, amelyben a friss, minőségi alapanyagok és a tradicionális receptek dominálnak.
        </p>
        
        <p className="text-gray-700 mb-4">
          Az egyik legismertebb fogás a <strong>rondai gazpacho</strong>, amely a klasszikus spanyol hideg paradicsomleves
